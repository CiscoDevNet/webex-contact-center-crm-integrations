...
| 4   | adavanceSearchCrmObjectName             | CRM object name and object field name in Zendesk within which the CAD variable value will be searched e.g. user npi : , where user = crm_object and npi = crm_object_field | Mandatory field for advanced search.                                                                                                                                                                                         |
