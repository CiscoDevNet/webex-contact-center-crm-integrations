...
| 9   | phoneCallActivityRecordConfig            |  Added new desktop layout property to enable or disable automatic dispaly and  creation of phone call activity. This is the JSON object {"createActivityRecordForInboundCall":true,"createActivityRecordForOutboundCall":true,"openActivityRecordAutomatically":false}. This has mainly three properties; The first property createActivityRecordForInboundCall helps to enable or disable the automatic phone call activity record creation for inbound calls whereas the property   createActivityRecordForOutboundCall  enable or disable the automatic phone call activity record creation for outbound calls. The third property openActivityRecordAutomatically helps to enable or disable the automatic display of phone call activity record to agent.     |                                                                                                                                                |
